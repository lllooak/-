      ...
      const handleBookingSubmit = async (formData: BookingFormData) => {
        ...
        try {
          ...
          if (paymentError || !payment?.success) {
            // If payment fails, try to revert request status or delete it
          ...
          const estimatedDelivery = formatDeliveryTime(ad.duration);

          // Call to send fan confirmation email (already in your emailService.ts)
          sendOrderConfirmationEmail(
            ...
            estimatedDelivery
          ).catch(emailError => console.error('Error sending fan confirmation email:', emailError));
          ...
          if (!creatorError && creatorData?.email) {
            ...
            await sendCreatorOrderNotificationEmail(
              ...
              formData.message,
              ad.price
            ).catch(emailError => console.error('Error sending creator notification email:', emailError));
          }
